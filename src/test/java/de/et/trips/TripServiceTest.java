...
public class TripServiceTest {
    ...
    public void testGroupTrips() {
        ...
        Trip trip2 = new Trip("2", "John", "Truck01", "New York", LocalDateTime.parse("13.12.2015 09:13", df));
        ...
        assertThat(group2.getGroupProperty().getDriver(), is("Lea"));
        assertThat(group2.getGroupProperty().getVehicle(), is("Truck02"));
    }
}